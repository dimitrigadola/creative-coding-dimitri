...
function setup() {
  ...
  b1.position((width / 2) - 470, height - 40);
  let b2 = createButton('Siya');
  b2.position((width / 2) - 400, height - 40);
  let b3 = createButton('Donald');
  b3.position((width / 2) - 325, height - 40);
  let b4 = createButton('Greta');
  b4.position((width / 2) - 255, height - 40);
  let b5 = createButton('Elizabeth');
  b5.position((width / 2) - 170, height - 40);
  let b6 = createButton('Charles');
  b6.position((width / 2) - 85, height - 40);
  let b7 = createButton('Alice');
  b7.position((width / 2) + 15, height - 40);
  let b8 = createButton('Benedikt');
  b8.position((width / 2) + 70, height - 40);
  let b9 = createButton('Ching-te');
  b9.position((width / 2) + 180, height - 40);
  let b10 = createButton('Jinping');  
  b10.position((width / 2) + 260, height - 40);
  let b11 = createButton('Taylor');
  b11.position((width / 2) + 360, height - 40);
  let b12 = createButton('Harrsion');
  b12.position((width / 2) + 420, height - 40);
