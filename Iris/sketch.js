...
function setup() {
  ...
  b1.position((width / 2) - 650, height - 40);
  let b2 = createButton('Siya');
  b2.position((width / 2) - 580, height - 40);
  let b3 = createButton('Donald');
  b3.position((width / 2) - 450, height - 40);
  let b4 = createButton('Greta');
  b4.position((width / 2) - 380, height - 40);
  ...
  b7.position((width / 2) + 93, height - 40);
  let b8 = createButton('Benedikt');
  b8.position((width / 2) + 145, height - 40);
  let b9 = createButton('Ching-te');
  b9.position((width / 2) + 300, height - 40);
